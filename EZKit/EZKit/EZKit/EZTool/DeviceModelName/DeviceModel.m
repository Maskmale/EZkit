...
+ (BOOL)iPodTouch {
    ...
    if ([[[self deviceModelName] substringToIndex:10] isEqualToString:@"iPod touch"]) {
        iPodTouch = YES;
    }
...
+ (BOOL)iPhone {
    ...
    if ([[[self deviceModelName] substringToIndex:6] isEqualToString:@"iPhone"]) {
        iPhone = YES;
    }
...
+ (BOOL)iPad {
    ...
    if ([[[self deviceModelName] substringToIndex:4] isEqualToString:@"iPad"]) {
        iPad = YES;
    }
